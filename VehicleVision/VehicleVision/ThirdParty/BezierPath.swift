// Source: https://raw.githubusercontent.com/agordeev/BezierPathClosestPoint/master/BezierPathClosestPoint/BezierPath.swift
//  BezierPath.swift
//  Twiggi
//
...
struct HitTester {
    ...
    struct PointOnPath {
        let p: CGPoint
        let distanceAlongPath: CGFloat
    }
    
    /// Lookup table is an array containing real points for the path.
    private(set) var lookupTable = [PointOnPath]()
    
    mutating func generateLookupTable() {
        ...
        for command in points {
            ...
            case .addLineToPoint:
                ...
                for i in 0...capacityPerPiece {
                    ...
                    lookupTable.append(PointOnPath(p: point, distanceAlongPath: <#T##CGFloat#>))
                }
